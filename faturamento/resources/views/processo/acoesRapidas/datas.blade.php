<div class="btn-group">
    <button type="button" data-value="anterior" class="btn btn-back-number btn-sm btn-success">
        < </button>
            <div class="btn-group">
                <button id='button-pai' type="button"
                    class="btn btn-back-number btn-success btn-sm dropdown-toggle btn-sm" data-toggle="dropdown"
            ...
            <button type="button" data-value="proximo" class="btn btn-back-number btn-success btn-sm">></button>
</div>
