...
@section('content')
<input type='hidden' id='tipo' name='finalizado' value='finalizado'>
<div class="row">
    <div class="col-12">
...
<div class="row">
    <div class="col-6">
        ...
        <a href="{{ route('processo.completo') }}" class="ml-1 btn-concluidos-number btn btn-sm btn-success-number" style="text-decoration: underline;">
            Concluidos
