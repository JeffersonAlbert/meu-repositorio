<div id="formBuscaGrid" class="card-body-dt text-number-wt mt-2" style="display: none;">
    <form id="formBuscar" action="{{ route("processo.index") }}" method="GET">
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-sm-2">
                <label class="label-number" for="data-pagamento-inicial">Pagamento Inicial:</label>
                <input id='data-pagamento-inicial' name="data-pagamento-inicial" class="input-login form-control" type="date" name="data-pagamento-inicial">
            </div>
            <div class="form-group col-sm-2">
                <label class="label-number" for="data-pagamento-final">Pagamento Final:</label>
                <input id="data-pagamento-final" name="data-pagamento-final" class="input-login form-control" type='date'>
            </div>
        </div>
        <div class="form-row">
