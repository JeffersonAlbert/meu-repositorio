...
@section('content')
<input type='hidden' id='tipo' name='pendentes' value='pendentes'>
<div class="row">
    <div class="col-12">
...
<div class="row">
    <div class="col-6">
        ...
        <a href="{{ route('processo.pendentes') }}" class="ml-1 btn-pendentes-number btn btn-sm btn-success-number" style="text-decoration: underline;">
            Pendentes
