{{-- adicionar Despesa --}}
<div class="modal fade" id="addDREDespesa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Nova Categoria Despesa</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <form id="formAddDREDespesa">
                            @csrf
                            <input type="hidden" value='despesa' name='tipo'>
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <select id="dre-pai" name='dre-pai' class="input-login select-number form-control form-select">
                                        ...
                                        @foreach($despesa as $categoriaReceita)
                            ...
                            <div class="mt-3 row">
                                <div class="col-6">
                                    ...
                                    @foreach($vinculoDreDespesa as $vinculo)
            ...
            <div class="modal-footer">
                ...
                <button id="enviarDREDespesa" type="button" class="btn btn-success btn-back-number btn-submit">Confirmar</button>
            </div>
        </div>
    </div>
</div>
