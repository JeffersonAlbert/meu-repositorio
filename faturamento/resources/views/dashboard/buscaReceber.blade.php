<div id="buscarDisplay" class="card w-100 mb-3" style="display: none;">
    <div class="card-body-dt text-number-wt">
        <form action="#" id="formSearchRelatorioReceber">
            <div class="form-row">
                ...
                <div class="form-group col-3">
                    <label for="cliente" class="label-number">Cliente</label>
                    <input class="form-control input-login" type="text" name="cliente" id="cliente">
                </div>
                <div class="form-group col-3">
                    <label for="categoria" class="label-number">Categoria</label>
                    <select name="categoria" id="categoria" class="input-login form-control form-select select-number" aria-label=".form-select">
