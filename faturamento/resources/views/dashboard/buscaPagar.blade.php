<div id="buscarDisplay" class="card w-100 mb-3" style="display: none;">
    <div class="card-body-dt text-number-wt">
        <form action="#" id="formRelatorioPagar">
            <div class="form-row">
                <div class="form-group col-3">
                    <label for="trace_code" class="label-number">Identificação</label>
                    <input class="form-control input-login" type="text" name="trace_code" id="trace_code">
                </div>
                <div class="form-group col-3">
                    <label for="fornecedor" class="label-number">Fornecedor</label>
                    <input class="form-control input-login" type="text" name="fornecedor" id="fornecedor">
                </div>
                <div class="form-group col-3">
                    <label for="tipo_cobranca" class="label-number">Tipo de cobrança</label>
                    <select name="tipo_cobranca" id="tipo_cobranca" class="input-login form-control form-select select-number" aria-label=".form-select">
                        <option value="0">Selecione o tipo de cobrança</option>
                ...
                <div class="form-group col-3">
                    ...
                    <select name="centro_custo" id="centro_custo" class="input-login form-control form-select select-number" aria-label=".form-select">
