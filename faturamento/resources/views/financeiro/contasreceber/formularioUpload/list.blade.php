...
<div class="col">
    <table class="table table-responsive-sm table-head-number table-bordered">
        ...
        @foreach(json_decode($contasReceber->files_types_desc) as $key => $filesTypesDesc)
            <tr>
                ...
                <td class="td-grid-font align-middle">
                    ...
                    <button id="removerArquivo" data-id="{{ $contasReceber->id}}" class="btn-sm btn-danger btn removerArquivo">
