                ...
                <div class="card-body">
                    ...
                    <form action="recuperar-senha" method="POST">
                        ...
                        <div class="row justify-content-center mt-3">
                            <h3 class="font-regular-dt font-login">Recuperação de senha.</h3>
                        </div>
                        <div class="row justify-content-center mt-3">
                            <div class="col-12">
                                <input name="email" id="email" type="email" class="input-login form-control" placeholder="seu email aqui">
                            </div>
                        </div>
                        <div class="row justify-content-center mt-3">
                            <div class="font-regular-dt font-login" style="font-size: 18px">
                                Será enviado um e-mail para a conta selecionada.
                            </div>
                        </div>
                        <div class="row justify-content-center mt-3">
                            <div class="font-regular-dt font-login" style="font-size: 18px">
                                Por favor confira esse email para recuperar a senha.
                            </div>
                        </div>
                        <div class="row justify-content-center mt-3">
                            <button class="btn btn-success btn-success-number btn-lg">Enviar</button>
                        </div>
                    </form>
                </div>
            </div>
