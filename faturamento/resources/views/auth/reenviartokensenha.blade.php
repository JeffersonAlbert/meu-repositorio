    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="card card-login o-hidden border-0 shadow-lg my-5">
                <div class="card-body">
                    <form action="{{ route('revalidar-token-usuario') }}" method="POST">
                        @csrf
                        <input type="hidden" name='token_url' value="{{ $user->token_url }}">
                        <input type="hidden" name='token_password' value="{{ $user->token_password }}">
                        ...
                        <div class="row justify-content-center mt-3">
                            <div class="font-regular-dt font-login" style="font-size: 18px">
                                Para enviar um novo token para o e-mail {{ $user->email }}, favor enviar esse formulario e validar o registro.
                            </div>
                        </div>
                        <div class="row justify-content-center mt-3">
                            <div class="font-regular-dt font-login" style="font-size: 18px">
