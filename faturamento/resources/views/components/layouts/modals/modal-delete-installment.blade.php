...
<div wire:ignore.self class="modal fade secondModal" id="deleteInstallment"
     tabindex="-1" role="dialog" aria-labelledby="deleteInstallmenttLabel"
            ...
            <div class="modal-body">
                ...
                <div @class(['row'])>
                    ...
                    <div @class(['col'])>
                        <div @class(['row'])>
                            <div @class(['col'])>
                                <button type="button" class="btn btn-danger" data-dismiss="modal" wire:click="deleteAccount">
                                    Sim desejo excluir!
                                </button>
                            </div>
                            <div @class(['col'])>
