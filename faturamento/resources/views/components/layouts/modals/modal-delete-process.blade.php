...
<div wire:ignore.self class="modal fade secondModal" id="modalDeleteProcess"
     tabindex="-1" role="dialog" aria-labelledby="modalDeleteProcessLabel"
                    ...
                    <div @class(['col'])>
                        <div @class(['alert', 'alert-warning'])>
                            <span class="font-extra light-dt delete-text">
                                Você está prestes a excluir um processo e suas parcelas.
                                Deseja continuar?
                            </span>
                        </div>
                    </div>
