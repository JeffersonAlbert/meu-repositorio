            ...
            <div @class(['card-body'])>
                ...
                <div class="row mt-3 mb-3">
                    <div class="col">
                        <div class="custom-control custom-switch">
                            <input wire:model="tax"  name="imposto" type="checkbox" class="custom-control-input" id="switch-imposto">
                ...
                <div @class(['row', 'mt-1'])>
                    ...
                    <div class="col">
                        ...
                        <input wire:model.live.debounce.500ms="totalValue" id="valor_total" name="valor" type="text" class="input-login form-control currency-type"
                               placeholder="0,00">
                    ...
                    <div class="col">
                        ...
                        <input wire:model.live.debounce.500ms="valueOfTheFirstInstallment" id="valorPrimeiraParcela" name="valor0" type="text" class="input-login form-control currency-type" placeholder="0,00">
                        @if(isset($errorMessages['valueOfTheFirstInstallment']))
                            <span class="text-danger font-extra-light-dt">{{ $errorMessages['valueOfTheFirstInstallment'][0] }}</span>
                        @endif
                    </div>
                    <div class="col">
                        <label class="label-number" for="dataPrimeiraParcela">Data 1ª parcela</label>
                        ...
                        @if(isset($errorMessages['dateOfTheFirstInstallment']))
                            <span class="text-danger font-extra-light-dt">{{ $errorMessages['dateOfTheFirstInstallment'][0] }}</span>
                        @endif
                    </div>
                    @endif
                    <div class="col">
