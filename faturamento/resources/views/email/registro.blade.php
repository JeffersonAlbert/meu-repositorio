...
<body style="background: #D8F3E6">
    <div class="container">
        ...
        <!-- Conteúdo -->
        <div class="content">
            <h1>Bem vindo ao Number!</h1>
            <span>Olá {{ $data['name'] }} {{ $data['last_name'] }},<br><br>

                Para garantir a segurança de sua conta e proteger seus dados, solicitamos que você confirme sua identidade inserindo <a href="{{ route('valida-cadastro', ['token' => $data['token']]) }}">neste link</a> o código de validação abaixo:
            <span>
                <br><br>
